...
![agent](<screenshots/claude agent.png>)
...
![alt text](screenshots/audi.png)

---

#### Screenshot 3 — `cost-optimizer.md` frontmatter showing the model and tools configuration

![alt text](screenshots/cost.png)
...
![alt text](screenshots/delegate.png)

---

#### Screenshot 5 — Security audit report output

![alt text](<screenshots/sy report.png>)
...
![alt text](<screenshots/cost report.png>)
